    ...
    return queryInterface.bulkInsert('Cocktails', [
      {
        ...
        {name: `French 75`, liquorType: `Gin`, userId:1, ingredients: `2 ounces of gin, topped with champagne to top of glass, garnish with lime peel.`, directions: `Add gin to champagne flute, fill to the top with champagne, garnish with lime peel.`, imgUrl: 'https://atthegarages.net/wp-content/uploads/2020/05/French-75.jpg',createdAt: new Date(), updatedAt: new Date()},
